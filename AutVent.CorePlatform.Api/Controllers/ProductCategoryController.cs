...
public class ProductCategoryController(IProductCategoryService productCategoryService) : ApiControllerBase
{
    ...
    {
        var response = await productCategoryService.GetAllAsync(request, cancellationToken);
    ...
    {
        var response = await productCategoryService.CreateBatchAsync(request, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
    ...
    {
        var response = await productCategoryService.DeleteAsync(id, cancellationToken);
        return StatusCode(response.StatusCode, response);
    }
}
