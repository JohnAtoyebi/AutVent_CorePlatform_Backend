...
public interface IInvoiceService
{
    ...
    Task<ApiResponse<InvoiceResponse>> MarkAsSentAsync(long storeId, long invoiceId, MarkInvoiceAsSentRequest request, CancellationToken cancellationToken = default);
